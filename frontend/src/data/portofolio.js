...
const androidDevelopment = [
  {
    thumbnail:
      "https://raw.githubusercontent.com/shubhamMadheshiya/Assets/refs/heads/main/1.png",
    name: "JOIN (Android App)",
    shortDis:
      "JOIN is a robust chat application offering real-time messaging with secure, end-to-end encryption. Built on android using Kotlin as language, it leverages Firebase for the backend. Advanced features include group chats, media sharing, smart typing indicators, and read receipts.",

    skills: ["Kotlin", "Firebase", "Java", "Recycler View", "Android Studio"],
    liveLink:
      "https://drive.google.com/file/d/1ausC3D7595XMZpPhgDPOqRN4PmJBCcil/view?usp=drive_link",
    github: "https://github.com/shubhamMadheshiya/Join.git",
    duration: "Fab 2022 - Mar 2022",
    readingTime: 5,
    listDis: [
      "Service offering real-time chatting and messaging from a mobile application.",
      "A user friendly Password Manager application that stores user id password and name.",
      "Use firebase fire store to store and retrieve data.",
      "Firebase Auth UI is used to login into a respective user account.",
      "Has an inbuilt user-friendly password generator.",
      "Implemented smart typing indicators and read receipts for enhanced user experience",
      "Use the firebase database cloud to store messaging data.",
...
const backend = [
  {
    ...
    readingTime: 4,
    listDis: [
      "Nactor is a RESTful API project built using Node.js, Express, and Mongoose.",
      "Provides backend solutions for managing user authentication, tours, reviews, and bookings.",
      "Features secure user sign-up, login, password reset, and update functionalities.",
      "Enables tour creation, update, deletion, and retrieval of tour details.",
      "Allows management of user reviews for tours.",
      "Handles bookings and payments using Stripe integration.",
      "Incorporates robust security measures including Helmet, rate limiting, data sanitization, and JWT authentication.",
      "Uses Nodemailer and SendGrid for sending email notifications.",
      "Optimizes images with Sharp for efficient storage and retrieval.",
      "Environment configuration is handled using environment variables for flexibility.",
      "Employs ESLint and Prettier for code quality and formatting.",
      "Utilizes development tools like Nodemon and Parcel-bundler for efficient development workflows.",
      "Renders views using Pug as the template engine.",
      "Designed to be scalable, secure, and easy to maintain.",
      "Provides comprehensive backend functionalities for building robust RESTful APIs.",
    ],
  },
];
