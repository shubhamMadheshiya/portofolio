const experiences = [
  {
    ...
    website: "https://aafs.ae/", // replace if actual site differs
    logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVCM7iu8V7Mmr3HU_2uO7FVrhuJUeV0QkDyw&s", // replace with real logo if available
    date: "March 2025 – Present",
    location: "Hyderabad, Telangana",
    jobType: "Onsite", // update if Remote/Onsite
    employmentType: "Full-time",
    listDis: [
      "Worked on a FinTech platform as a full-stack developer using Next.js and Spring Boot",
      "Built Jenkins pipelines for Maven-based projects with Checkstyle, SonarQube, and Nexus, achieving 100% CI coverage with Slack notifications and Docker Hub integration",
      "Deployed and monitored microservices using Kubernetes on AWS, provisioned infrastructure with Terraform, and managed configurations with Ansible",
      "Applied real-time monitoring and alerting using Grafana and CloudWatch, improving uptime to 99.9%",
      "Upgraded frontend routing from Pages Router to App Router, enhancing navigation structure and code organization",
      "Migrated API integration from Axios to RTK Query, reducing load by 40% and redesigned 70% of the UI with MUI",
      "Implemented Redis caching on the frontend server to store static backend data for 24 hours, cutting API response time by 60% and improving system throughput",
      "Transitioned version control from SVN to GitLab, streamlining development workflows and reducing merge conflicts by 50%",
    ],
    dis: "",
  },
  {
